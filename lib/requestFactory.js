...
var createWhoAmIRequest = function(organizationEndpoint, tokens) {
  var whoAmIRequest = '<s:Envelope xmlns:s="http://www.w3.org/2003/05/soap-envelope" xmlns:a="http://www.w3.org/2005/08/addressing" xmlns:u="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd">' +
      createHeader(organizationEndpoint, tokens, "Execute") +
...
var createHeader = function(organizationEndpoint, tokens, message) {
  var header = '<s:Header><a:Action s:mustUnderstand="1">http://schemas.microsoft.com/xrm/2011/Contracts/Services/IOrganizationService/' + message + '</a:Action>' +
...
var createRequest = function(organizationEndpoint, tokens) {
    var createRequest = '<s:Envelope xmlns:s="http://www.w3.org/2003/05/soap-envelope" xmlns:a="http://www.w3.org/2005/08/addressing" xmlns:u="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd">' +
        createHeader(organizationEndpoint, tokens, "Create") +
          '<s:Body>' +
...
exports.createWhoAmIRequest = createWhoAmIRequest;
